            ...
            {filtered.map(p => {
              ...
              return (
                ...
                >
                  ...
                  <span className="mono" style={{ fontWeight: 700 }}>€{p.value}M</span>
                  <span className="mono" style={{ fontWeight: 700, color: up ? "#37ff63" : "#ff285d" }}>
                    {up ? "+" : ""}{p.change_24h}%
                  </span>
                  <span className="mono" style={{ fontWeight: 700, color: "rgba(255,255,255,.65)" }}>{p.rating}</span>
                  <Spark data={gen_spark(p.change_24h, p.id, 16)} color={up ? "#37ff63" : "#ff285d"} width={100} height={24} />
