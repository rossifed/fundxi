      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
        ...
        <button
          ...
          style={{
            ...
            color: edit_mode ? "var(--color-positive)" : "rgba(255,255,255,.35)",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: on ? "var(--color-positive)" : "rgba(255,255,255,.35)",
                      cursor: "pointer", fontFamily: "inherit",
      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 }}>
          {[
            ...
            { label: "Win Rate", value: TRADING_STATS.win_rate, color: "var(--color-positive)" },
            { label: "Best Trade", value: TRADING_STATS.best_trade, color: "var(--color-positive)" },
            { label: "Streak", value: TRADING_STATS.streak, color: "rgba(255,255,255,.5)" },
            { label: "Leagues", value: TRADING_STATS.leagues, color: "var(--color-positive)" },
          ].map((s, i) => (
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        <button
          ...
          style={{
            ...
            background: "rgba(55,255,99,.08)", color: "var(--color-positive)",
